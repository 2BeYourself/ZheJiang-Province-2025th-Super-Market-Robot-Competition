...
//                }
         ...
         //每5秒打印一次调试信息
//        if (++debug_cnt >= 100)  // 50ms * 100 = 5秒
//        {
//            debug_cnt = 0;
//            extern volatile uint32_t uart2_rx_callback_count;
//            extern volatile uint32_t uart2_rx_bytes;
//            rt_kprintf("[DEBUG] RX callbacks: %d, bytes: %d, flags: 0x%02X\n",
//                       uart2_rx_callback_count, uart2_rx_bytes, s_cDataUpdate);
//        }
