...
//#define BSP_UART1_RX_USING_DMA      /* 控制台禁用DMA，避免IDLE中断导致的命令延迟 */
//#define BSP_UART2_RX_USING_DMA      /* 禁用 DMA，改用中断接收方式（参考官方例程）*/
//#define BSP_UART3_RX_USING_DMA      /* 使能 DMA 驱动模式 */
#define BSP_UART4_RX_USING_DMA      /* 使能 DMA RX */
#define BSP_UART4_TX_USING_DMA      /* 使能 DMA TX - 电机控制使用DMA发送提升效率 */
